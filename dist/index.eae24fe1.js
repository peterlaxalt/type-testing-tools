...
})({"eTONP":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "ea664b00eae24fe1";
"use strict";
...
},{}],"4rqvy":[function(require,module,exports) {
class VariableFontTools {
    ...
    log(msg, extras = " ", isError = false) {
        ...
        if (!isError) console.log("vf ~ " + msg, extras);
        else console.error("vf ~ " + msg, extras);
    }
    init() {
...
},{}]},["eTONP","4rqvy"], "4rqvy", "parcelRequire9208")

//# sourceMappingURL=index.eae24fe1.js.map
