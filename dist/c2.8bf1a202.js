...
})({"02xwH":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "1c44a5298bf1a202";
...
},{}],"5aNgs":[function(require,module,exports) {
class c2 {
    constructor(){
        this.dom = {
            wrapper: {
    ...
    generateBodyFilter() {
        ...
        let contrast = Math.floor(Math.random() * 1) + 1;
        let invert = Math.random() > 0.5 ? 1 : 0;
    ...
    handleCursorMove(e) {
        ...
        let finalX = cX - cW / 2;
        let finalY = cY - cH / 2;
        if (!this.mouseHasMovedOnce && !cursor.classList.contains('--a')) cursor.classList.add('--a');
    ...
    createCursor() {
        function updateCursor() {
            ...
            if (isBlueClass) cursor.classList.add(this.cursorConfig.blueClass);
            else cursor.classList.add(this.cursorConfig.redClass);
    ...
    log(msg, extras = " ", isError = false) {
        ...
        if (!isError) console.log("c2 ~ " + msg, extras);
        else console.error("c2 ~ " + msg, extras);
    }
    init() {
...
},{}]},["02xwH","5aNgs"], "5aNgs", "parcelRequire9208")

//# sourceMappingURL=c2.8bf1a202.js.map
